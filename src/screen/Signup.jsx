  ...
  return (
    ...
    <div style={{height:"100vh",marginLeft:"350px"}} className='d-flrx  align-items-center  justify-content-center w-100 '> 
       ...
       <div className='from-group mb-2'>
        ...
        <input style={{width:"500px",height:"40px"}} type="text" className='from-control' ref={name}  required /> 
        </div> 
       <div className='from-group mb-2'>
        ...
        <input style={{width:"500px",height:"40px"}} type="password" className='from-control'  ref={password} required /> 
        </div>  
        ...
        <button onClick={handleclick} style={{width:"500px",height:"40px"}} type='submit' className='btn w-100 btn-success mt-2'>SIGN Up</button>    
